...
const BCrumb = [
  ...
  },
  {
    ...
    title: "Etik Gerekliliklere ï¿½liï¿½kin Bildirim",
  },
];
...
const Page = () => {
  ...
  return (
    <>
      <Breadcrumb title="Etik Gerekliliklere ï¿½liï¿½kin Bildirim" items={BCrumb}>
        <>
          {isMobile ? (
      ...
      <PageContainer
        title="Etik Gerekliliklere ï¿½liï¿½kin Bildirim"
        description="this is Etik Gerekliliklere ï¿½liï¿½kin Bildirim"
      >
        <Grid container>
          <Grid size={12}>
