...
const BCrumb = [
    ...
    {
        to: "/StandartCalismaKagitlari/TespitEdilenHususlarinYonetimeBildirimi",
        title: "Tespit Edilen Hususların Yönetim Bildirimi",
    },
];
...
const Page = () => {
    ...
    return (
        <>
            ...
            <PageContainer
                title="Tespit Edilen Hususların Yönetim Bildirimi"
                description="this is Tespit Edilen Hususların Yönetim Bildirimi"
            >
                <Box>
